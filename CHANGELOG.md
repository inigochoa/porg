...
- Version checking on each script run

## [0.1.0] - 2021-01-08

### Added

- Authors file with the official author list for copyright purposes.
- A changelog containing all notable changes to this project.
- A code of conduct to set the behavior guidelines of the community related to
this project.
- A guide that explains how to contribute in many different ways to this
project.
...
[Unreleased]: https://github.com/inigochoa/porg/compare/0.3.0...HEAD
[0.3.0]: https://github.com/inigochoa/porg/compare/0.2.0...0.3.0
[0.2.0]: https://github.com/inigochoa/porg/compare/0.1.0...0.2.0
[0.1.0]: https://github.com/inigochoa/porg/releases/tag/0.1.0
